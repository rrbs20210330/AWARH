...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('CVrdcc','files/CVrdcc.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('CVadur','files/CVadur.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('CVaasv','files/CVaasv.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('Contractnoc','files/Contractnoc.pdf');
SELECT MAX(`id_file`) INTO @Contrato FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('Photonoc','files/Photonoc.pdf');
SELECT MAX(`id_file`) INTO @Foto FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('CVnoc','files/CVnoc.pdf');
SELECT MAX(`id_file`) INTO @CV FROM `files`;
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('Contractmmf','files/Contractmmf.pdf');
SELECT MAX(`id_file`) INTO @Contrato1 FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('Photommf','files/Photommf.pdf');
SELECT MAX(`id_file`) INTO @Foto1 FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('CVmmf','files/CVmmf.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A1C1E1','files/A1C1E1.pdf');
SELECT MAX(`id_file`) INTO @Archivo1C1E1 FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A2C1E1','files/A2C1E1.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A1C2E1','files/A1C2E1.pdf');
SELECT MAX(`id_file`) INTO @Archivo1C2E1 FROM `files`;
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A2C2E1','files/A2C2E1.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A1C3E1','files/A1C3E1.pdf');
...
INSERT INTO `files`(`t_name`, `t_path`) VALUES ('A1C4E1','files/A1C4E1.pdf');
