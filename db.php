<?php 
    class db{
        ...
        public function proNewCandidate($name,$phone_number,$email,$appointment_date,$request_position,$perfil){
            $sql = "INSERT INTO `candidate` (`name`,phone_number,email,appointment_date,request_position,perfil) 
            VALUES ('$name','$phone_number','$email',$appointment_date, $request_position,'$perfil')";
            $res = mysqli_query($this->con, $sql);
            if ($res){
                return true;
            }
        ...
        public function read_all_candidate(){
