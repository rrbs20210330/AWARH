      ...
      <tr>
          <td>
              <form method="post">
                ...
                <input autocomplete="off"  type="hidden" name="typeOp" value="13">
              <?php if ($active == 0){?>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-6">
              ...
              <input autocomplete="off"  type="text" class="form-control" id="user" name="user" maxlength="30" required value="">
            </div>
            <div class="col-sm-6">
              <label for="password">Contraseña</label>
              <input autocomplete="off"  type="text" class="form-control" id="password" name="password" maxlength="40" required>
            </div>          
          </div>
          <input autocomplete="off"  type="hidden" name="typeOp" value="1">
          ...
          <form method="post" id="formul" onsubmit="return confirm('Estás seguro?\nTus datos serán guardados.');">
            <div class="modal-body">
              <div class="row">
                <div class="col-sm-4">
                  <label >Usuario </label>
                  <input autocomplete="off"  type="text" class="form-control" id="user" name="user" maxlength="30" <?php if($tipo === 2){ ?> disabled <?php }?> value="<?php echo $user?>">
                </div>
                <div class="col-sm-4">
                  <label >Contraseña</label>
                  <input autocomplete="off"  type="text" class="form-control" id="password" name="password" maxlength="40" required value="<?php echo $password?>">
                </div>           
              </div>
              <input autocomplete="off"  type="hidden" name="id" value="<?php echo $id?>">
              <input autocomplete="off"  type="hidden" name="typeOp" value="1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form  method="post">
            ...
            <input autocomplete="off"  type="hidden" name="typeOp" id="typeOp" value="1">
