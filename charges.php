        ...
        <div class="modal-content">
            ...
            <form method="post" onsubmit="return confirm('Estás seguro?\nTus datos serán guardados.');">
                <div class="modal-body"> 
                    ...
                    <input autocomplete="off"  type="hidden" name="typeOp" value="6">
            ...
            <form method="post" onsubmit="return confirm('Estás seguro?\nTus datos serán guardados.');">
                <div class="modal-body"> 
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="">Nombre </label>
                            <input autocomplete="off"  type="text" class="form-control" id="name" name="name" maxlength="50" value="<?php echo $nombre ?>">
                        </div>
                        <div class="col-sm-12">
                            <label for="">Descripción </label>
                            <textarea class="form-control" id="description" name="description" maxlength="256" required rows="1"><?php echo $description ?></textarea>
                        </div>                    
                    </div>
                    <br>
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <form method="post">
            ...
            <input autocomplete="off"  type="hidden" name="typeOp" id="typeOp" value="3">
